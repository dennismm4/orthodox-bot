...
def main_menu_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("Day 1 Flashcards", callback_data="start_day_1")],
        [InlineKeyboardButton("Day 2 Flashcards", callback_data="start_day_2")],
        [InlineKeyboardButton("Day 3 Flashcards", callback_data="start_day_3")],
