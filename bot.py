...
DAYS = {
    ...
    "4": {"label": "Day 4 Flashcards", "folder": "images4"},
}

DAY_OPEN = {day: True for day in DAYS}
QUIZ_OPEN = {"1": True, "2": True, "3": True, "4": True, "5": True}
QUIZ_STATS = {
...
DAY_QUIZ_STATS = {
    ...
    "2": {"started": 0, "completed": 0, "score_total": 0},
    "3": {"started": 0, "completed": 0, "score_total": 0},
    "4": {"started": 0, "completed": 0, "score_total": 0},
    "5": {"started": 0, "completed": 0, "score_total": 0},
}
...
DAY2_QUIZ = [
    {
        "question": "Christian theology?",
        "options": {
            "A": "After Christ's resurrection",
            "B": "Before the birth of Jesus Christ",
            "C": "Apostolic writings",
            "D": "Book of Revelation era",
        },
        "answer": "B",
        "explanation": "The Old Testament period is understood as the time before the birth of Jesus Christ.",
    },
    {
        "question": "How many covenants are traditionally listed in the Old Testament according to the lesson?",
        "options": {"A": "Five", "B": "Six", "C": "Seven", "D": "Eight"},
        "answer": "C",
        "explanation": "The lesson lists seven Old Testament covenants.",
    },
    {
        "question": "Which covenant comes immediately after the Edenic Covenant in the biblical sequence?",
        "options": {
            "A": "Davidic Covenant",
            "B": "Noahic Covenant",
            "C": "Mosaic Covenant",
        ...
        "answer": "B",
        "explanation": "The Noahic Covenant follows the Edenic Covenant in the sequence.",
    },
    {
        "question": "According to Genesis 1:26–27, in whose image and likeness was man created?",
        "options": {"A": "Angels", "B": "Earth", "C": "God", "D": "Moses"},
        "answer": "C",
        "explanation": "Genesis 1:26-27 teaches that man was created in the image and likeness of God.",
    },
    {
        "question": "What does Genesis 1:26–27 emphasize about the nature of God in relation to creation?",
        "options": {
            "A": "God is distant from creation",
            "B": "God is only justice",
            "C": "God is love and relational",
            "D": "God is only power",
        },
        "answer": "C",
        "explanation": "The lesson emphasizes God as loving and relational in relation to creation.",
    },
    {
        "question": "What is the meaning of the Tree of Knowledge of Good and Evil in the lesson’s interpretation?",
        "options": {
            "A": "Human wisdom",
        ...
        "answer": "B",
        "explanation": "The tree is interpreted in connection with disobedience to God's command.",
    },
    {
        "question": "What does the Protoevangelium (Genesis 3:15) refer to in Christian interpretation?",
        "options": {
            "A": "Creation of Adam",
            "B": "First prophecy of Christ's victory over Satan",
            "C": "Giving of the Ten Commandments",
            "D": "Story of Noah's Ark",
        },
        "answer": "B",
        "explanation": "Genesis 3:15 is interpreted as the first prophecy of Christ's victory over Satan.",
    },
    {
        "question": "In the Adam–Christ typology, Christ is described primarily as what?",
        "options": {
            "A": "A prophet among many",
            "B": "The perfect image of God",
            "C": "A new lawgiver only",
            "D": "A descendant of Abraham",
        },
        "answer": "B",
        "explanation": "In Adam-Christ typology, Christ is the perfect image of God.",
    },
    {
        "question": "What is the sign of the Noahic Covenant between God and humanity?",
        "options": {"A": "The cross", "B": "The dove", "C": "The rainbow", "D": "The olive branch"},
        "answer": "C",
        "explanation": "The rainbow is the sign of the Noahic Covenant.",
    },
    {
        "question": "In biblical typology, what does Noah's Ark symbolize?",
        "options": {
            "A": "The temple in Jerusalem",
            "B": "The Roman Empire",
            "C": "The Church as salvation",
            "D": "The Garden of Eden",
        },
        "answer": "C",
        "explanation": "Noah's Ark symbolizes the Church as salvation.",
    },
    {
        "question": "How is Abraham best described according to the Abrahamic Covenant?",
        "options": {
            "A": "First priest of Israel",
            "B": "Father of many nations",
            "C": "First king of Israel",
            "D": "Lawgiver of Israel",
        },
        "answer": "B",
        "explanation": "Abraham is described as the father of many nations.",
    },
    {
        "question": "What major event defines the Mosaic Covenant in salvation history?",
        "options": {
            "A": "Building of the Temple",
            "B": "Crossing of the Red Sea",
            "C": "Babylonian exile",
            "D": "Return from Babylon",
        },
        "answer": "B",
        "explanation": "The crossing of the Red Sea is central to the Mosaic Covenant in salvation history.",
    },
    {
        "question": "What was the main purpose of the Levitical Covenant given to the tribe of Levi?",
        "options": {
            "A": "Political leadership",
            "B": "Prophetic revelation",
            "C": "Sacrificial priesthood and worship",
            "D": "Military conquest",
        },
        "answer": "C",
        "explanation": "The Levitical Covenant concerns sacrificial priesthood and worship.",
    },
    {
        "question": "What is the central promise of the Davidic Covenant?",
        "options": {
            "A": "Material wealth",
            "B": "Eternal dynasty and throne",
            "C": "Victory over Egypt",
            "D": "Land inheritance",
        },
        "answer": "B",
        "explanation": "The Davidic Covenant promises an eternal dynasty and throne.",
    },
    {
        "question": "According to the lesson, what is the New Covenant ultimately defined as?",
        "options": {
            "A": "Political restoration of Israel",
            "B": "Theosis (participation in divine life)",
            "C": "Strict legal observance",
            "D": "Military liberation",
        },
        "answer": "B",
        "explanation": "The New Covenant is ultimately defined as Theosis: participation in divine life.",
    },
]

DAY3_QUIZ = [
    {
        "question": "Which doctrine teaches that God is one in essence and three in persons?",
        "options": {
            "A": "Polytheism",
            "B": "Atheism",
            "C": "Trinitarianism",
        ...
        "answer": "C",
        "explanation": "Trinitarianism",
    },
    {
        "question": "What do Christians mean when they say God is \"one in essence\"?",
        "options": {
            "A": "One divine nature",
            "B": "One divine person",
            "C": "One divine body",
        ...
        "answer": "A",
        "explanation": "One divine nature",
    },
    {
        "question": "Who are the three Persons of the Holy Trinity?",
        "options": {
            "A": "Father, Mary, and Jesus",
            "B": "Father, Son, and Holy Spirit",
            "C": "God, Angels, and Saints",
            "D": "Father, Son, and Church",
        },
        "answer": "B",
        "explanation": "Father, Son, and Holy Spirit",
    },
    {
        "question": "According to Orthodox teaching, the Son is eternally _________ of the Father.",
        "options": {
            "A": "Created",
            "B": "Adopted",
            "C": "Begotten",
        ...
        "answer": "C",
        "explanation": "Begotten",
    },
    {
        "question": "What term describes the mutual indwelling of the Father, Son, and Holy Spirit?",
        "options": {
            "A": "Theosis",
            "B": "Perichoresis",
            "C": "Asceticism",
        ...
        "answer": "B",
        "explanation": "Perichoresis",
    },
    {
        "question": "What does the word \"person\" (hypostasis) refer to in Trinitarian theology?",
        "options": {
            "A": "A separate god",
            "B": "A human being",
            "C": "A distinct personhood within the Godhead",
            "D": "An angelic being",
        },
        "answer": "C",
        "explanation": "A distinct personhood within the Godhead",
    },
    {
        "question": "Which view teaches that God is only one person who appears in different modes?",
        "options": {
            "A": "Trinitarianism",
            "B": "Modalism",
            "C": "Miaphysitism",
        ...
        "answer": "B",
        "explanation": "Modalism",
    },
    {
        "question": "Why is the doctrine of the Holy Trinity called a mystery?",
        "options": {
            "A": "It is secret knowledge",
            "B": "It was invented later",
            "C": "It is beyond human comprehension",
            "D": "It has no explanation",
        },
        "answer": "C",
        "explanation": "It is beyond human comprehension",
    },
    {
        "question": "Why did God become man according to Orthodox teaching?",
        "options": {
            "A": "To become an angel",
            "B": "To save humanity",
            "C": "To create a new law",
            "D": "To establish an earthly kingdom",
        },
        "answer": "B",
        "explanation": "To save humanity",
    },
    {
        "question": "What does the word \"Tewahedo\" emphasize about Christ?",
        "options": {
            "A": "His kingship",
            "B": "His resurrection",
            "C": "His one united nature after the Incarnation",
            "D": "His earthly ministry",
        },
        "answer": "C",
        "explanation": "His one united nature after the Incarnation",
    },
    {
        "question": "According to Orthodox teaching, Jesus Christ is both fully God and fully ________.",
        "options": {
            "A": "Angel",
            "B": "Prophet",
            "C": "King",
    ...
    {
        "question": "Why is Jesus the unique Mediator between God and humanity?",
        "options": {
            "A": "He is only a prophet",
            "B": "He is only a king",
            "C": "He is both fully God and fully man",
            "D": "He is the first disciple",
        },
        "answer": "C",
        "explanation": "He is both fully God and fully man",
    },
    {
        "question": "According to Orthodox teaching, which statement about Jesus is true?",
        "options": {
            "A": "He was created by God",
            "B": "He only appeared human",
            "C": "He is God incarnate",
            "D": "He was merely a teacher",
        },
        "answer": "C",
        "explanation": "He is God incarnate",
    },
    {
        "question": "Why did many Jewish leaders accuse Jesus of blasphemy?",
        "options": {
            "A": "He broke Roman laws",
            "B": "He claimed equality with God",
            "C": "He refused to perform miracles",
            "D": "He denied the prophets",
        },
        "answer": "B",
        "explanation": "He claimed equality with God",
    },
    {
        "question": "What is the main difference between Christ's intercession and the intercession of the saints?",
        "options": {
            "A": "Christ is an angel",
            "B": "Saints have greater authority",
            "C": "Christ intercedes as the eternal Son and High Priest",
            "D": "Saints do not pray for others",
        },
        "answer": "C",
        "explanation": "Christ intercedes as the eternal Son and High Priest",
    },
]

DAY4_QUIZ = [
    {
        "question": "What does Soteriology study?",
        "options": {"A": "Angels", "B": "Salvation", "C": "Worship", "D": "History"},
        "answer": "B",
        "explanation": "Salvation",
    },
    {
        "question": "Salvation ultimately means:",
        "options": {"A": "Wealth", "B": "Heaven only", "C": "Theosis", "D": "Knowledge"},
        "answer": "C",
        "explanation": "Theosis",
    },
    {
        "question": "Christ saved us from:",
        "options": {"A": "Hunger", "B": "Poverty", "C": "Sin", "D": "Sleep"},
        "answer": "C",
        "explanation": "Sin",
    },
    {
        "question": "Death entered through:",
        "options": {"A": "Satan", "B": "Adam's sin", "C": "Moses", "D": "Rome"},
        "answer": "B",
        "explanation": "Adam's sin",
    },
    {
        "question": "The Orthodox view of salvation is:",
        "options": {"A": "Fate", "B": "Synergy", "C": "Chance", "D": "Logic"},
        "answer": "B",
        "explanation": "Synergy",
    },
    {
        "question": "Synergy means:",
        "options": {"A": "God alone", "B": "Humans alone", "C": "Cooperation", "D": "Obedience"},
        "answer": "C",
        "explanation": "Cooperation",
    },
    {
        "question": "Faith without works is:",
        "options": {"A": "Complete", "B": "Perfect", "C": "Holy", "D": "Dead"},
        "answer": "D",
        "explanation": "Dead",
    },
    {
    ...
    {
        "question": "Which sacrament is the new birth?",
        "options": {"A": "Eucharist", "B": "Baptism", "C": "Matrimony", "D": "Priesthood"},
        "answer": "B",
        "explanation": "Baptism",
    },
    {
        "question": "Baptism unites us with Christ's:",
        "options": {
            "A": "Teaching",
            "B": "Kingdom",
        ...
        "answer": "C",
        "explanation": "Death and Resurrection",
    },
    {
        "question": "Chrismation is the:",
        "options": {
        ...
        "answer": "A",
        "explanation": "Seal of the Holy Spirit",
    },
    {
        "question": "The Eucharist is also called:",
        "options": {"A": "Myron", "B": "Qurbana", "C": "Nisha", "D": "Synod"},
        "answer": "B",
        "explanation": "Qurbana",
    },
    {
        "question": "Repentance in Greek is:",
        "options": {"A": "Logos", "B": "Agape", "C": "Metanoia", "D": "Koinonia"},
        "answer": "C",
        "explanation": "Metanoia",
    },
    {
        "question": "What is the first step of repentance?",
        "options": {"A": "Confession", "B": "Contrition", "C": "Penance", "D": "Forgiveness"},
        "answer": "B",
        "explanation": "Contrition",
    },
    {
        "question": "The Prodigal Son illustrates:",
        "options": {"A": "Baptism", "B": "Priesthood", "C": "Repentance", "D": "Marriage"},
        "answer": "C",
        "explanation": "Repentance",
    },
    {
        "question": "The process of becoming like God is:",
        "options": {
            "A": "Canonization",
            "B": "Sanctification",
            "C": "Theosis",
    ...
    {
        "question": "Orthodox theology views sin mainly as:",
        "options": {"A": "Crime", "B": "Debt", "C": "Sickness", "D": "Weakness"},
        "answer": "C",
        "explanation": "Sickness",
    },
    {
        "question": "Pelagianism teaches salvation by:",
        "options": {
            "A": "Grace alone",
            "B": "Human effort alone",
            "C": "Faith alone",
            "D": "Sacraments",
        },
        "answer": "B",
        "explanation": "Human effort alone",
    },
    {
        "question": "Divine Monergism teaches salvation by:",
        "options": {"A": "Church", "B": "Saints", "C": "God alone", "D": "Angels"},
        "answer": "C",
        "explanation": "God alone",
    },
]

DAY5_QUIZ = [
    {
        "question": "Who issued the Edict of Milan?",
        "options": {"A": "Nero", "B": "Constantine", "C": "Diocletian", "D": "Julian"},
        "answer": "B",
        "explanation": "Constantine",
    },
    {
        "question": "The Edict of Milan granted:",
        "options": {"A": "Taxes", "B": "Freedom of worship", "C": "Citizenship", "D": "Land"},
        "answer": "B",
        "explanation": "Freedom of worship",
    },
    {
        "question": "Constantine defeated Maxentius at:",
        "options": {"A": "Nicaea", "B": "Rome", "C": "Milvian Bridge", "D": "Antioch"},
        "answer": "C",
        "explanation": "Milvian Bridge",
    },
    {
        "question": "Constantine saw:",
        "options": {"A": "Angel", "B": "Fire", "C": "Cross of light", "D": "Eagle"},
        "answer": "C",
        "explanation": "Cross of light",
    },
    {
        "question": "Constantine's mother was:",
        "options": {"A": "Martha", "B": "Helena", "C": "Anna", "D": "Thekla"},
        "answer": "B",
        "explanation": "Helena",
    },
    {
        "question": "St. Helena discovered the:",
        "options": {"A": "Ark", "B": "Tomb", "C": "True Cross", "D": "Temple"},
        "answer": "C",
        "explanation": "True Cross",
    },
    {
        "question": "The First Council of Nicaea met in:",
        "options": {"A": "313 AD", "B": "325 AD", "C": "381 AD", "D": "451 AD"},
        "answer": "B",
        "explanation": "325 AD",
    },
    {
        "question": "How many bishops attended Nicaea?",
        "options": {"A": "70", "B": "150", "C": "250", "D": "318"},
        "answer": "D",
        "explanation": "318",
    },
    {
        "question": "Who taught that Christ was created?",
        "options": {"A": "Athanasius", "B": "Nicholas", "C": "Arius", "D": "Peter"},
        "answer": "C",
        "explanation": "Arius",
    },
    {
        "question": "Arius was from:",
        "options": {"A": "Jerusalem", "B": "Alexandria", "C": "Rome", "D": "Antioch"},
        "answer": "B",
        "explanation": "Alexandria",
    },
    {
        "question": "Who defended Christ's full divinity?",
        "options": {"A": "Arius", "B": "Athanasius", "C": "Eusebius", "D": "Licinius"},
        "answer": "B",
        "explanation": "Athanasius",
    },
    {
        "question": "Athanasius was a:",
        "options": {"A": "Soldier", "B": "Governor", "C": "Archdeacon", "D": "Monk"},
        "answer": "C",
        "explanation": "Archdeacon",
    },
    {
        "question": "According to tradition, who slapped Arius?",
        "options": {"A": "Constantine", "B": "Athanasius", "C": "Nicholas", "D": "Helena"},
        "answer": "C",
        "explanation": "Nicholas",
    },
    {
        "question": "The Council condemned:",
        "options": {"A": "Nestorius", "B": "Arius", "C": "Cyril", "D": "Basil"},
        "answer": "B",
        "explanation": "Arius",
    },
    {
        "question": "Nicaea produced the:",
        "options": {"A": "Didache", "B": "Creed", "C": "Psalter", "D": "Canon"},
        "answer": "B",
        "explanation": "Creed",
    },
    {
        "question": "The Nicene Creed states Christ is:",
        "options": {"A": "Created", "B": "Lesser god", "C": "True God", "D": "Prophet"},
        "answer": "C",
        "explanation": "True God",
    },
    {
        "question": "\"Homoousios\" means:",
        "options": {"A": "Similar substance", "B": "One substance", "C": "Two natures", "D": "One person"},
        "answer": "B",
        "explanation": "One substance",
    },
    {
        "question": "Athanasius Contra Mundum means:",
        "options": {
            "A": "Athanasius the Teacher",
            "B": "Athanasius Against the World",
            "C": "Athanasius the Great",
            "D": "Athanasius the Martyr",
        },
        "answer": "B",
        "explanation": "Athanasius Against the World",
    },
    {
        "question": "Constantine convened Nicaea to address:",
        "options": {"A": "Icons", "B": "Arianism", "C": "Monasticism", "D": "Persecution"},
        "answer": "B",
        "explanation": "Arianism",
    },
    {
        "question": "Christianity became tolerated under:",
        "options": {"A": "Nero", "B": "Constantine", "C": "Trajan", "D": "Hadrian"},
        "answer": "B",
        "explanation": "Constantine",
    },
    {
        "question": "The Church of the Holy Sepulchre was built under:",
        "options": {"A": "Julian", "B": "Constantine", "C": "Theodosius", "D": "Nero"},
        "answer": "B",
        "explanation": "Constantine",
    },
    {
        "question": "The Age of Martyrs largely ended after:",
        "options": {"A": "Pentecost", "B": "Nicaea", "C": "Constantine's rise", "D": "Chalcedon"},
        "answer": "C",
        "explanation": "Constantine's rise",
    },
]

DAY_QUIZZES = {
    "1": {"label": "Day 1 Quiz", "questions": DAY1_QUIZ},
    "2": {"label": "Day 2 Quiz", "questions": DAY2_QUIZ},
    "3": {"label": "Day 3 Quiz", "questions": DAY3_QUIZ},
    "4": {"label": "Day 4 Quiz", "questions": DAY4_QUIZ},
    "5": {"label": "Day 5 Quiz", "questions": DAY5_QUIZ},
}
...
def main_menu_kb():
    rows = []
    if any(DAY_OPEN.values()):
        rows.append([InlineKeyboardButton("Flashcards", callback_data="show_flashcards_menu")])
    if any(QUIZ_OPEN.values()):
        rows.append([InlineKeyboardButton("Quiz", callback_data="show_quiz_menu")])
    rows.append([InlineKeyboardButton("ℹ️ About", callback_data="about")])
    rows.append([InlineKeyboardButton("Exit", callback_data="exit_home")])
    return InlineKeyboardMarkup(rows)

def flashcards_menu_kb():
    rows = []
    ...
    rows.append([InlineKeyboardButton("Go Back", callback_data="main_menu")])
    rows.append([InlineKeyboardButton("Exit", callback_data="exit_home")])
    return InlineKeyboardMarkup(rows)

def quiz_menu_kb():
    rows = []
    for day, quiz_config in DAY_QUIZZES.items():
        if QUIZ_OPEN[day]:
            rows.append([
                InlineKeyboardButton(
                    quiz_config["label"],
                    callback_data=f"start_day_{day}_quiz",
                )
            ])
    rows.append([InlineKeyboardButton("Go Back", callback_data="main_menu")])
    rows.append([InlineKeyboardButton("Exit", callback_data="exit_home")])
...
def admin_menu_kb():
    ...
    for day, quiz_config in DAY_QUIZZES.items():
        quiz_action = "Close" if QUIZ_OPEN[day] else "Open"
        rows.append([
            InlineKeyboardButton(
                f"{quiz_action} {quiz_config['label']}",
                callback_data=f"admin_toggle_quiz_{day}",
            )
        ])
...
def admin_status_text() -> str:
    ...
    for day, quiz_config in DAY_QUIZZES.items():
        quiz_status = "Open" if QUIZ_OPEN[day] else "Closed"
        lines.append(f"{quiz_config['label']}: {quiz_status}")
    return "\n".join(lines)
...
def stats_text() -> str:
    ...
    for day, quiz_config in DAY_QUIZZES.items():
        quiz_stats = DAY_QUIZ_STATS[day]
        completed = quiz_stats["completed"]
        average = int(quiz_stats["score_total"] / completed) if completed else 0
        lines.extend([
            quiz_config["label"],
            f"Started: {quiz_stats['started']}",
            f"Completed: {completed}",
            f"Average score: {average}/{len(quiz_config['questions'])}",
            "",
        ])
    return "\n".join(lines).strip()
...
def health_text() -> str:
    lines = [
        ...
        f"Quiz sets configured: {len(DAY_QUIZZES)}",
        "",
    ]
    ...
    for day, quiz_config in DAY_QUIZZES.items():
        lines.extend([
            quiz_config["label"],
            f"Status: {'Open' if QUIZ_OPEN[day] else 'Closed'}",
            f"Questions: {len(quiz_config['questions'])}",
            "",
        ])
...
async def show_bootcamp_ready(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await query.edit_message_text(
        ...
        "Choose what you would like to review.",
        reply_markup=main_menu_kb(),
    )

async def show_flashcards_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.edit_message_text(
        "Choose a flashcard review:",
        reply_markup=flashcards_menu_kb(),
    )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("quiz_answer_"):
        ...
        return
    if data.startswith("start_day_") and data.endswith("_quiz"):
        await begin_day1_quiz(update, context)
        return
    if data.startswith("start_day_"):
        await show_day_ready(update, context)
        return
    if data.startswith("confirm_day_"):
        await begin_quiz(update, context)
        return
    if data.startswith("admin_toggle_quiz_"):
        await toggle_quiz(update, context)
        return
    ...
    dispatch = {
        ...
        "show_flashcards_menu": show_flashcards_menu,
        "show_quiz_menu": show_quiz_menu,
...
async def toggle_quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    quiz_day = query.data.replace("admin_toggle_quiz_", "")
    QUIZ_OPEN[quiz_day] = not QUIZ_OPEN[quiz_day]
    await query.edit_message_text(
        admin_status_text(),
        reply_markup=admin_menu_kb(),
    )
...
async def begin_day1_quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    day = query.data.replace("start_day_", "").replace("_quiz", "")
    quiz_config = DAY_QUIZZES[day]

    if not QUIZ_OPEN[day]:
        await query.edit_message_text(
            f"{quiz_config['label']} is currently closed.",
            reply_markup=quiz_menu_kb(),
        )
        return

    questions = random.sample(quiz_config["questions"], len(quiz_config["questions"]))
    DAY_QUIZ_STATS[day]["started"] += 1
    context.user_data.update({
        "active_flow": "quiz",
        "quiz_day": day,
        "quiz_label": quiz_config["label"],
    ...
    await query.edit_message_text(f"Starting {quiz_config['label']}...")
...
async def answer_day1_quiz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if ud.get("active_flow") != "quiz" or ud.get("quiz_answered"):
        return
...
async def show_day1_quiz_results(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    day = ud.get("quiz_day", "1")
    quiz_label = ud.get("quiz_label", "Quiz")

    DAY_QUIZ_STATS[day]["completed"] += 1
    DAY_QUIZ_STATS[day]["score_total"] += score

    text = (
        f"{quiz_label} Complete\n\n"
        "📖 Quiz Completed\n"
...
async def _send_admin_quiz_report(context, user, ud):
    ...
    lines = [
        f"📋 *New {ud.get('quiz_label', 'Quiz')} Result*",
        f"🕐 {ts}",
        "",
        f"👤 {user.first_name} {user.last_name or ''}",
...
async def setup_bot_commands(app: Application):
    user_commands = [
        BotCommand("start", "Open Orthodoxia Flashcards & Quiz"),
